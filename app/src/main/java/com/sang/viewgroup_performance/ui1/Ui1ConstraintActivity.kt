...
class Ui1ConstraintActivity : AppCompatActivity() {
    private lateinit var viewLoadTrace: Trace

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ui1_constraint)
        ...
        FirstDrawListener(
            ...
            object : FirstDrawListener.OnFirstDrawCallback {
                override fun onDrawingStart() {
                    viewLoadTrace =
                        FirebasePerformance.startTrace("Test-Ui1-ConstraintLayout-DrawingTime")
                }
