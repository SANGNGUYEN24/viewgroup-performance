...
class Ui3OtherLayoutActivity : AppCompatActivity() {
    private lateinit var viewLoadTrace: Trace

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ui3_other_layout)
        ...
        FirstDrawListener(
            ...
            object : FirstDrawListener.OnFirstDrawCallback {
                override fun onDrawingStart() {
                    viewLoadTrace =
                        FirebasePerformance.startTrace("Test-Ui3-OtherLayouts-DrawingTime")
                }
