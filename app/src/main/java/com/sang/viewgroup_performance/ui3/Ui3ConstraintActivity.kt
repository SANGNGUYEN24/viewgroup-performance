package com.sang.viewgroup_performance.ui3
...
class Ui3ConstraintActivity : AppCompatActivity() {
    private lateinit var viewLoadTrace: Trace

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ui3_constraint)
        ...
        FirstDrawListener(
            ...
            object : FirstDrawListener.OnFirstDrawCallback {
                override fun onDrawingStart() {
                    viewLoadTrace = FirebasePerformance.startTrace("Test-Ui3-ConstraintLayout-DrawingTime")
                }
